...
sed -i '' "s/versionName \"$old_version_name\"/versionName \"$new_version_name\"/g" ./app/build.gradle
sed -i '' "s/versionName \"$old_version_name\"/versionName \"$new_version_name\"/g" ./wearos/build.gradle
