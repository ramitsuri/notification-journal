...
adb -s $WEARABLE_SERIAL shell monkey -p com.ramitsuri.notificationjournal -c android.intent.category.LAUNCHER 1

ANDROID_SERIAL=$PHONE_SERIAL ./gradlew :app:installDebug
adb -s $PHONE_SERIAL shell monkey -p com.ramitsuri.notificationjournal -c android.intent.category.LAUNCHER 1
